		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappzapplicationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappzapplicationui-display": {
								"semanticObject": "comappzapplicationui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.zapplicationui",
									"url": sap.ui.require.toUrl("com/app/zapplicationui")
								}
							}
						}
					}
